...
use App\Http\Requests\OmnifyBase\BranchStoreRequestBase;

#[OA\Schema(
    schema: 'BranchStoreRequest',
    required: ['console_branch_id', 'console_org_id', 'code', 'name', 'is_headquarters', 'is_active'],
    properties: [
        new OA\Property(property: 'console_branch_id', type: 'integer', example: 1),
...
class BranchStoreRequest extends BranchStoreRequestBase
{
    /**
